Ext.define('Goals.util.Messages', {
    singleton: true,
  ...
  EMPLOYEEREPORT: {
    TOAST: {
        ...
        WINFILTER: 'Something went wrong while apllying the filters',
    ...
    VIEWPORT:{
        PROFILECHNAGE: 'Something went wrong while changing the profile!!!',
        PERSONALACCESS:  'Something went wrong while checking the personal access!!!',
        VALIDATE: 'Something went wrong while validating!!!', 
        AUTHENTICAT: 'Something went wrong while checking the authentication is true or false!!!', 
        CURRENTVIEW: 'Something went wrong while setting the current view!!!',
        SELECTIONCHANGE: 'Something went wrong while changing the selected navigation!!!',
        ACCOUNTMSG: 'Would you like to leave this page? Without updating the changes',
        ACCOUNT:  'Something went wrong while leaving the account !!!',
        ACCOUNTRESETFUNCTION:  'Something went wrong while resetting the account !!!',
        NAVITREECHANGEAFTER: 'Something went wrong after changing the navigation !!!',
        ORGCHATNAVIGATION:  'Something went wrong while  navigating the organization chart !!!',
        ROUTECHANGE:  'Something went wrong while changing the route!!!',
        BENCH: 'Something went wrong while navigating the bench view !!!',
        STORELOAD: 'Something went wrong while loading the store !!!',
        ACCPAGELV:  'Would you like to leave this page?',
        ONPROFILECLICK: 'Something went wrong while clicking in our own profile !!!',
        LOGOUT: 'Something went wrong while logout!!!',
        MAINCONTAINERSCROLL: 'Something went wrong while scrolling!!!',
        FEED: 'Something went wrong while checking the feed data!!!',
        NEXTFEED: 'Something went wrong while checking the naxt feed data!!!',
        FEEDNOTIFICATIONCLICK: 'Something went wrong while checking on the feed notification!!!',
        HOMEPAGELOADING: 'Something went wrong while loading the home page !!!',
        LOADUSERDETAIL: 'Something went wrong while loading the user details !!!',
        COMPANYLOGO: 'Something went wrong while clicking on company logo!!!',
        MORDENPROFILEBTN: 'Something went wrong while clicking on modern profile butten!!!',
        SEARCHBTN: 'Something went wrong while searching!!!',
        TABCHANGE:  'Something went wrong while changing the tab!!!',
        KARMASCOREWINDOW: 'Something went wrong while opening the karma score window!!!',
        KARMASETUPFILTERS: 'Something went wrong while setting the karma score !!!',
        KARMACLEAR: 'Something went wrong while clearing the karma score !!!',
        ONSCROLL: 'Something went wrong while scrolling !!!',
        REDEEM: 'Something went wrong while clicking on redeem button !!!',
        NOMINATEBTN: 'Something went wrong while clicking on nominate button !!!',
        LOCATION:  'Something went wrong while showing the location!!!',
    }
});
