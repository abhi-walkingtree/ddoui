 ...
 */
    ...
    onMomClick: function(btn, e, eOpts, isPublish) {
        ...
        var win = btn.up('window'),
         ...
         successCallback = function(data) {
            if(projectId){
                store.load({
                    params: {
                        projectId: window.location.hash.split('/')[1]
                    },
                    callback: function() {
        ...
        this.alertMessages(windowFormValues,startDateValue,winStartTime,win,winEndTime,winDuration,windowEditorValue,winTagPartcipants,winTagAbsentees ,isActionItemsEmpty,isPublish,btn); 
    },
    /**
