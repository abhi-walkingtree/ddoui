...
Ext.define('DDO.view.setup.employeesetup.WorkDetailsController', {
    ...
    onStatusSelect: function (combo, record, eOpts) {
        try {
            ...
            if (selection && selection == "Probation") {
                me.onProbationSelection(vm, separatedDtView, noticeDtView, confirmedDtView);
            } else if (selection && selection == "Confirmed") {
                me.onConfirmSelection(vm, separatedDtView, noticeDtView, confirmedDtView);
                ...
                me.onNoticeSelection(vm, separatedDtView, noticeDtView);
            } else {
     ...
     */
    onProbationSelection: function(vm, separatedDtView, noticeDtView, confirmedDtView){
     ...
     * @param {confirmedDtView} Object, reference of confirm date field
     */
    onConfirmSelection: function(vm, separatedDtView, noticeDtView, confirmedDtView){
     ...
     * @param {noticeDtView} Object, reference of notice date field.
     */
    onNoticeSelection: function(vm, separatedDtView, noticeDtView){
        vm.set('workdetailssavebutton', true);
        vm.set('isDateSelected', true);
